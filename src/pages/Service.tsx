...
const Service = () => {
  return (
    <div className="bg-white p-4">
      ...
      <div className="bg-[#17BC3D] p-4 text-white rounded-3xl w-48 text-center text-lg">
        <p>Services</p>
      </div>
      <div className="my-5 text-center">
      <h3 className="text-5xl md:my-7">Get more information about what we provide to our clients</h3>
      <p className="my-4 text-center text-2xl">MoveSmart offers reliable and efficient moving services for both residential and commercial needs. From packing and loading to transportation and storage, we ensure a seamless experience. Trust us to handle your move with care, professionalism, and attention to detail.</p>
      </div>
      </div>
